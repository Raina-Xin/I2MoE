...
from src.common.fusion_models.m3care import M3Care
...
def parse_args():
    parser = argparse.ArgumentParser(description="m3care")
...
def main():
    args, _ = parse_args()
    logger = setup_logger(
        f"./logs/baseline/m3care/{args.data}", f"{args.data}", f"{args.modality}.txt"
    )
