...
do
for hidden_dim in 64 # 64 128 256
do
for num_patches in 4 # 8 16
do
for num_experts in 8 #8 16 32
do
...
do
CUDA_VISIBLE_DEVICES=$device python src/ablation/moepp/moepp_less_perturbed_forward.py \
